...
public class ManagerController implements BrewObserver {
    ...
    public void initialize() {
        ...
        // Register as an observer for real-time updates [3-5]
    ...
    /**
     * Reacts to notifications from the Model layer [2, 6].
     */
    @Override
    ...
    /**
     * Adds quantity to a selected ingredient [7].
     */
    @FXML
    ...
    /**
     * Removes the selected item from the catalog [4].
     */
    @FXML
    ...
    /**
     * Toggles whether an item is currently available for customers [8].
     */
    @FXML
